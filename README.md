...
Using a small non-linear data set, the user can select K-means or Kernel K-means algorithms and define the number of clusters and <img src="http://www.sciweavers.org/tex2img.php?eq=%20%5Clambda%20&bc=White&fc=Black&im=jpg&fs=12&ff=mathdesign&edit=0" align="bottom" border="0" alt=" \lambda " width="15" height="14" />(when using Kernel K-means).
